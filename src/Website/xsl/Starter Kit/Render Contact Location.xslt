...
<!--=============================================================
    File: Render Contact Location.xslt                                                   
    Created by: sitecore\admin                                       
    Created: 12/6/2007 11:36:28 AM                                               
...
<xsl:template name="RenderContactLocation">
  ...
  <xsl:if test="(sc:fld('address line 1',.)!='') or (sc:pageMode()/pageEditor/edit)">
    <p>
      ...
      <xsl:if test="(sc:fld('address line 3',.)!='') or (sc:pageMode()/pageEditor/edit)">
        <br/>
        <sc:text field="address line 3" show-title-when-blank="true"/>
      </xsl:if>
    </p>
  </xsl:if>
  ...
  <xsl:if test="(sc:fld('info email',.)!='') or (sc:pageMode()/pageEditor/edit)">
    <a href="mailto:{sc:fld('info email',.)}">
      <sc:text field="info email" show-title-when-blank="true"/>
    </a>
  </xsl:if>
  ...
  <xsl:if test="(sc:fld('sales email',.)!='') or (sc:pageMode()/pageEditor/edit)">
    <a href="mailto:{sc:fld('sales email',.)}">
      <sc:text field="sales email" show-title-when-blank="true"/>
    </a>
  </xsl:if>
</xsl:template>
